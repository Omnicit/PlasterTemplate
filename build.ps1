...
param(
    ...
    [ValidateSet('?',
        'afterbuild',
        'afterbuildhelp',
        'afterbuildupdatablehelp',
        'aftergeneratefilecatalog',
        'afterinstall',
        'afterpublish',
        'afterstagefiles',
        'analyze',
        'beforebuild',
        'beforebuildhelp',
        'beforebuildupdatablehelp',
        'beforegeneratefilecatalog',
        'beforeinstall',
        'beforepublish',
        'beforestagefiles',
        'build',
        ...
        'buildupdatablehelp',
        'clean',
        'corebuildupdatablehelp',
        'coregeneratefilecatalog',
        'coreinstall',
        'corepublish',
        'corestagefiles',
        'default',
